...
warehouse2 = {'x': 1,'y': 0.5,'z': 1}
customer1 = {'x': -0.5,'y': -0.5,'z': 0.7}
customer2 = {'x': -1,'y': 1,'z': 0.7}
customer3 = {'x': -1,'y': -0.5,'z': 0.7}

name_waypoints = {'crazyflie5_takeoff': drone1_takeoff, 'crazyflie6_takeoff': drone2_takeoff,
